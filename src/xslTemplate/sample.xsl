...
<body >
	...
	<p>[<a class="menulink" href="#Summary">Summary</a>] [<a class="menulink" href="#EH_Smells_List">EH Smells List</a>] [<a class="menulink" href="#Package_List">Package List</a>] </p>
  ...
  <tr bgcolor="#EAEADA" class="bigbluetext"><th>Ignore Checked Exception</th><th>
	...
	<xsl:for-each select="AllPackageList/Package">
		<tr bgcolor="#F7F7F7" class="text" align="right">
			<td align="left" class="forumline1" width="133" height="23"><a>
	...
	<xsl:for-each select="PackageList/Package">
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="1" class="forumline" id="table2">
			...
			<xsl:for-each select="ClassList/SmellData">
				<tr bgcolor="#F7F7F7" class="text" align="right">
					<td class="forumline1"><a class="menulink"><xsl:value-of select="ClassName"></xsl:value-of></a></td>
			...
			<tr bgcolor="#E5E5E5" class="text" align="right">
				<td style="text-align: left" class="forumline1" colspan="2"><span class="text2"><strong>Total</strong></span></td>
