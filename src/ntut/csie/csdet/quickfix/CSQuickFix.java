...
//	private ASTRewrite rewrite;
	...
	public void run(IMarker marker) {
		try {
			...
			logger.error("[CSQuickFix] EXCEPTION ",e);
			e.printStackTrace();
		}
	}
	
	/**
	 * 找出要被Quick fix的method node
...
//			//取得該method所丟出的例外
//			List<SimpleName> exceptionList = method.thrownExceptions();
//			//自行建立一個要丟出的exception
//			SimpleName throwName = ast.newSimpleName(exception);
//			//將例外值放回list中
//			exceptionList.add(throwName);
